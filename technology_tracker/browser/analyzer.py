...
from technology_tracker.core.config import extension_path
    ...
    def _create_driver(self):
        ...
        for attempt in range(self.max_retries):
            try:
                ...
                # Add headless mode and Docker-specific arguments
                options.add_argument("--headless")
                options.add_argument("--no-sandbox")
                options.add_argument("--disable-dev-shm-usage")
                
                # Docker içinde webdriver-manager ile driver yolunu bulmak bazen sorun olabilir,
                # bu yüzden service nesnesi ile yönetmek daha güvenlidir.
                ...
                # driver.maximize_window() # Headless modda gerek yok
